...
vim.keymap.set("n", "<leader>h", function() local harpoon = require("harpoon") harpoon.ui:toggle_quick_menu(harpoon:list()) end, {desc = "harpoon quick menu"})
...
-- trouble
-- TODO: cambiar
vim.keymap.set("n", "<leader>t", "<cmd>Trouble diagnostics toggle filter.buf=0<cr>", {silent = true, noremap = true})
...
-- Runner
vim.api.nvim_set_keymap('n', '<D-r>', ':w<CR>:!python3 %<CR>', { noremap = true, silent = true })
